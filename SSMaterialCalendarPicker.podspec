#
#  Be sure to run `pod spec lint SSMaterialCalendarPicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Iuri Chiba" => "iurichiba@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/iurichiba/SSMaterialCalendarPicker.git", :tag => "v1.2.10" }
